...
class TestCalculator(unittest.TestCase):
    ...
    def test_fun6(self):
        self.assertEqual(calculator.fun5(4, 5), 3.0)
        self.assertEqual(calculator.fun5(0, 0), 0.0)
        self.assertEqual(calculator.fun5(1, 3), 2.0)
        self.assertEqual(calculator.fun5(9, 16), 5.0)
